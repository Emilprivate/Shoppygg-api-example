...
class Shoppy {
  ...
  getProducts() {
    return this.makeRequest('products', {}, body => {
      // log the entire body to inspect its structure
      console.log('Response body:', body);
  
      // check if body.data is an array as expected
      if (Array.isArray(body.data)) {
        return body.data;
      } else {
        // if not, handle this scenario appropriately, such as by throwing an error
